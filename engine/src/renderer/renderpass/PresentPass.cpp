...
// FIX: temp, until I make swapchain images also handles
namespace hk {
...
void PresentPass::render(const hk::ImageHandle &source,
...
//
//     const auto info = hk::vkcontext::adapter_info();
//
